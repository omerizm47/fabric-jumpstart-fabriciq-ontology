...
# 
# **Press `Run all` — this builds the **media** demo end-to-end (data load → ontology → two Data Agents).**
...
# ## Build the demo
# 
# This install option themes the whole demo (ontology, sample data, and both Data Agents) to **media**.

# CELL ********************

# This install option builds the media demo end-to-end: it fetches the
# media ontology package and runs 01 (data load) then 02 (ontology + two Data Agents).
import os
import time
