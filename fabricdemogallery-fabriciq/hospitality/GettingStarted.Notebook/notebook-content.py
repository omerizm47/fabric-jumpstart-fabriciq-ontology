...
# 
# **Press `Run all` — this builds the **hospitality** demo end-to-end (data load → ontology → two Data Agents).**
...
# ## Build the demo
# 
# This install option themes the whole demo (ontology, sample data, and both Data Agents) to **hospitality**.

# CELL ********************

# This install option builds the hospitality demo end-to-end: it fetches the
# hospitality ontology package and runs 01 (data load) then 02 (ontology + two Data Agents).
import os
import time
